...
- Name: comprehensive-qa-test.spec.ts >> 🧪 QA Test Suite - Account 1 (Dzahar) >> 4. 🎯 Daily Missions Display
...
- generic [active] [ref=e1]:
      ...
      - generic [ref=e1705]:
        - generic [ref=e1706]:
          - generic "Click me to play!" [ref=e1707] [cursor=pointer]:
            - img "Calico pixel cat" [ref=e1708]
          - generic [ref=e1943]:
            - generic [ref=e1944]:
              - generic [ref=e1945]:
  ...
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e5039]:
        - img [ref=e5041]
        - generic [ref=e5045]: Welcome back, Dzaharap! 👑
