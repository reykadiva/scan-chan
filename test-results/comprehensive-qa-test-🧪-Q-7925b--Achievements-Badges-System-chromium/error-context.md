...
- Name: comprehensive-qa-test.spec.ts >> 🧪 QA Test Suite - Account 1 (Dzahar) >> 5. 🏆 Achievements/Badges System
- Location: tests\comprehensive-qa-test.spec.ts:163:9

# Error details

```
Error: locator.count: Unexpected token "=" while parsing css selector "[class*="achievement"], [class*="badge"], text=/Achievement|Badge/i". Did you mean to CSS.escape it?
```
