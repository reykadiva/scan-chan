...
- Name: 09-responsive.spec.ts >> Responsive Layout >> Desktop (1280x720) >> should render Collection page without overflow
- Location: tests\e2e\09-responsive.spec.ts:36:11

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://127.0.0.1:3000/collection
Call log:
