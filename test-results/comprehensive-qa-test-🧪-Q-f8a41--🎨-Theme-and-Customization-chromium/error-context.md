...
- Name: comprehensive-qa-test.spec.ts >> 🧪 QA Test Suite - Account 2 (Reyka) >> 7. 🎨 Theme and Customization
- Location: tests\comprehensive-qa-test.spec.ts:209:9

# Error details

```
Error: locator.count: Unexpected token "/" while parsing css selector "button:has-text(/Theme|Customize|Style/i)". Did you mean to CSS.escape it?
```
...
- generic [active] [ref=e1]:
  ...
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e5038]:
        - img [ref=e5040]
        - generic [ref=e5044]: Welcome back, Reyka334! 👑
