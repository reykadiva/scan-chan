      ...
      <div className="flex items-center justify-between">
        ...
        {!activeBounty && (
          <motion.button
            ...
            className="px-4 py-1.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-fredoka font-bold rounded-full text-xs shadow-md hover:shadow-lg transition-all cursor-pointer"
          >
            🎯 New Bounty
          </motion.button>
        )}
          ...
          <motion.div
            ...
            className={`card-bubbly p-5 border-2 ${
              isExpired
                ...
                : 'bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-300 shadow-[0_0_20px_rgba(139,92,246,0.15)]'
            }`}
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-fredoka font-bold text-sm text-purple-700">
                    🎯 Cat Request
                  </span>
            ...
            {isExpired && (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={generateBounty}
                className="mt-3 w-full py-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-fredoka font-bold rounded-xl text-xs shadow-md hover:shadow-lg transition-all cursor-pointer"
              >
                🔄 Generate New Bounty
              </motion.button>
            )}
